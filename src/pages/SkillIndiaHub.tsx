...
export default function SkillIndiaHub() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50/50 dark:bg-[#090d16] text-slate-900 dark:text-slate-100 transition-colors">
      {/* Sleek Minimalist Header - Full Width */}
      <header className="sticky top-0 z-30 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-[#090d16]/80 backdrop-blur-md">
        <div className="w-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-10 h-14 flex items-center justify-between">
      ...
      <main className="w-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-10 py-8 space-y-6">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400 font-mono">Smart India Hackathon</span>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 p-1.5 bg-slate-100 dark:bg-slate-900/60 rounded-xl border border-slate-200/80 dark:border-slate-800/80 w-full">
          {ROLES_DATA.map((r) => (
            <button
              key={r.id}
              onClick={() => {
        ...
        {/* Expansive Hero Readiness Card */}
        <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 w-full">
          {/* Left: Role Info */}
          <div className="space-y-1.5 min-w-[280px]">
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 flex items-center gap-2.5">
          ...
          <div className="flex-1 max-w-xl space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-slate-500 font-medium">Industry Hiring Bar Readiness</span>
            ...
            <Progress value={role.readinessScore} className="h-2 bg-slate-100 dark:bg-slate-800" />
          ...
          <div className="flex flex-col md:items-end gap-1.5 shrink-0">
            <Button
              ...
              className="text-xs h-9 bg-slate-900 hover:bg-slate-800 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-medium px-5 shadow-sm"
            >
        ...
        {/* 2 Expansive Columns - Full Width */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
          {/* Left Column: Missing Skills (Critical Gaps) */}
          <div className="space-y-3">
            ...
            <div className="space-y-2.5">
              {role.criticalGaps.map((skill, idx) => (
                <div
                  key={idx}
                  className="p-3.5 rounded-xl border border-slate-200/70 dark:border-slate-800/70 bg-white dark:bg-slate-900/30 flex items-center justify-between gap-4 text-xs sm:text-sm hover:border-slate-300 dark:hover:border-slate-700 transition-colors"
                >
                  ...
                  <span className="px-2.5 py-0.5 rounded text-[11px] font-mono bg-rose-50 dark:bg-rose-950/30 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50 shrink-0 font-medium">
            ...
            <div className="pt-2">
              ...
              {showAlignedSkills && (
                <div className="mt-2.5 space-y-1.5 pl-3 border-l-2 border-slate-200 dark:border-slate-800">
            ...
            <div className="space-y-2.5">
              ...
              <div className="p-4 rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-900/30 space-y-2 hover:border-amber-500/30 transition-colors">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-slate-400 font-mono text-[11px]">Voke Engine</span>
                </div>
              ...
              <div className="p-4 rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-900/30 space-y-2 hover:border-slate-300 dark:hover:border-slate-700 transition-colors">
                <div className="flex items-center justify-between text-xs">
