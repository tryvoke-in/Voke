        ...
        {isOpen && (
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-black/90 backdrop-blur-2xl shadow-2xl flex flex-col h-full text-white">
              ...
              <div className="absolute top-0 left-0 right-0 h-28 bg-gradient-to-b from-sky-600/30 via-indigo-600/10 to-transparent pointer-events-none" />
              ...
              <div className="relative z-10 px-5 py-3.5 border-b border-white/10 flex items-center justify-between bg-white/5 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-sky-600 via-indigo-600 to-blue-600 flex items-center justify-center shadow-lg shadow-sky-500/25">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="hidden sm:inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold bg-sky-500/20 text-sky-300 border border-sky-500/30">
                        Ctrl+K
                      </span>
                    </div>
              ...
              <ScrollArea className="flex-1 p-4 overflow-x-hidden" ref={scrollRef}>
                {messages.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center p-4 py-6">
                    <div className="w-16 h-16 rounded-3xl bg-gradient-to-tr from-sky-600/20 to-blue-600/20 flex items-center justify-center mb-4 border border-sky-500/30 shadow-inner">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full max-w-[480px]">
                      {samplePrompts.map((prompt, idx) => (
                        <button
                          ...
                          className="text-xs text-left px-3.5 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-sky-500/40 text-gray-300 hover:text-white transition-all flex items-center justify-between group"
                        >
                  ...
                  <div className="space-y-4 pb-2">
                    {messages.map(message => (
                      ...
                      >
                        {message.role === "assistant" && (
                          <div className="w-8 h-8 rounded-full bg-sky-600/20 flex items-center justify-center border border-sky-500/30 shrink-0 mt-1">
                            ...
                            {message.action && (
                              <div className="mt-3 pt-2 border-t border-white/10">
                                <Button
                                  ...
                                  className="w-full h-8 text-xs bg-gradient-to-r from-sky-600 to-indigo-600 hover:from-sky-500 hover:to-indigo-500 text-white font-medium rounded-lg flex items-center justify-center gap-1.5 shadow-md"
                                >
                            ...
                            <div className="flex flex-wrap gap-1.5 mt-2">
                              {message.followUps.map((chip, cIdx) => (
                                <button
                                  ...
                                  className="text-[11px] px-2.5 py-1 rounded-lg bg-white/5 hover:bg-white/15 text-sky-300 hover:text-white border border-white/10 transition-colors flex items-center gap-1"
                                >
                    ...
                    {loading && (
                      <div className="flex gap-3 justify-start items-center">
                        <div className="w-8 h-8 rounded-full bg-sky-600/20 flex items-center justify-center border border-sky-500/30 shrink-0">
                          <Bot className="w-4 h-4 text-sky-400" />
                        </div>
              ...
              <div className="px-3.5 py-2 bg-white/5 border-t border-white/5 flex items-center flex-wrap gap-1.5 text-xs overflow-x-hidden">
                <span className="text-[10px] text-gray-400 font-medium shrink-0 flex items-center gap-1 mr-0.5">
                  <Compass className="w-3 h-3 text-sky-400" /> Quick Jump:
                </span>
                {[
              ...
              <div className="p-3.5 bg-black/60 backdrop-blur-md border-t border-white/10 relative z-10">
                ...
                >
                  <Input
                    ...
                    disabled={loading}
                    className={`flex-1 h-11 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-sky-500/60 focus:ring-sky-500/30 transition-all pl-4 pr-20 text-sm ${
                  ...
                  <div className="absolute right-1.5 top-1.5 flex items-center gap-1">
                    ...
                    <Button
                      ...
                      size="icon"
                      className="h-8 w-8 bg-gradient-to-r from-sky-600 to-indigo-600 hover:opacity-90 transition-opacity rounded-lg text-white shadow-md"
                    >
      ...
      >
        <div
          className={`absolute inset-0 rounded-full blur-xl transition-all duration-300 ${
            isOpen ? "bg-red-500/30" : "bg-sky-600/40 group-hover:bg-sky-600/70 animate-pulse"
          }`}
        />
        <div
          className={`
          ...
          ${
            isOpen
              ...
              : "bg-gradient-to-br from-sky-600 via-indigo-600 to-blue-600 text-white shadow-sky-500/30"
          }
        `}
        >
