      ...
      <motion.button
        ...
        className={
          iconOnly
            ...
            : "flex items-center gap-1.5 px-4 py-2 rounded-full bg-blue-700 text-white shadow-md shadow-sky-500/10 hover:shadow-sky-500/25 transition-all duration-300 whitespace-nowrap text-xs font-semibold cursor-pointer shrink-0"
        }
      >
